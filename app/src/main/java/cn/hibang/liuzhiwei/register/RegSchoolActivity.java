...
public class RegSchoolActivity extends BaseActivity implements OnItemClickListener,OnClickListener{	
...
//	listData.add(map);
	...
	return new SimpleAdapter(RegSchoolActivity.this, listData,
...
public void onItemClick(AdapterView<?> parent, View view, int position,
	...
	if (parent == lvSchoolItem) {
        ...
        Intent intent = new Intent(RegSchoolActivity.this,RegisterIdActivity.class); 
...
public void onClick(View v) {
	...
	case R.id.header_iv_setting_back:
		startActivity(new Intent(RegSchoolActivity.this,RegProvinceActivity.class));
		this.finish();
		break;
