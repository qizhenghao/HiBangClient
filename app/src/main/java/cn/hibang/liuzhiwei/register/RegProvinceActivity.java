...
public class RegProvinceActivity extends BaseActivity implements OnItemClickListener,OnClickListener{
...
//		listData.add(map);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (parent == lvProvinceItem) {
			...
			//Toast.makeText(mContext, map.get("text"), 1).show();
				...
				Intent intent = new Intent(RegProvinceActivity.this,RegSchoolActivity.class);
	...
	public void onClick(View v) {
		...
		case R.id.header_iv_setting_back:
			startActivity(new Intent(RegProvinceActivity.this,RegisterIdActivity.class));
			this.finish();
			break;
