package cn.hibang.liuzhiwei.android;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

import com.elife.ehelp.view.DialogLoading;
import com.example.newhaibang.R;

import cn.hibang.bruce.control.BaseApplication;
import cn.hibang.bruce.utils.NetManageUtils;
...
//		mLoadingDialog = new FlippingLoadingDialog(this, "请求提交中");
		if(!NetManageUtils.checkNetwork(this)) {
	        showCustomToast("网络抽风啦,请检查网络！");
...
//	}
	...
	protected void showLoadingDialog(String title) {
		loadingDialog = new DialogLoading(BaseActivity.this, title);
		loadingDialog.show();
	}
